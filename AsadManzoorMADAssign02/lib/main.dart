...
class _semesterBookState extends State<semesterBook> {
  ...
  Future<void> loadJSON() async {
    final String response = await rootBundle.loadString('assets/217967.json');
          ...
          actions: [
            CircleAvatar(
                ...
                backgroundImage: NetworkImage(
                    'https://i.ibb.co/3sf9qv1/IMG-20190507-143957-2.jpg')),
          ],
          title: Text(
            'Sadaqat Ali',
...
class _CourseState extends State<Course> {
  ...
  var blueHighlight = ["A", "B+", "B"];
  var greenHighlight = ["C+", "C"];
